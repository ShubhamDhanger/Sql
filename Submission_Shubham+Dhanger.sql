...
USE ORDERS1;
SELECT CONCAT(CASE CUSTOMER_GENDER WHEN 'M' THEN 'MR' WHEN 'F' THEN 'MS' END,' ',UPPER(CUSTOMER_FNAME),' ' ,UPPER(CUSTOMER_LNAME) )
 ...
 ELSE 'C' END AS CUSTOMERS_CATEGORY FROM ONLINE_CUSTOMER;
...
CASE WHEN P.PRODUCT_PRICE > '200000' THEN P.PRODUCT_PRICE*0.80
...
END AS NEW_PRICE FROM PRODUCT AS P
